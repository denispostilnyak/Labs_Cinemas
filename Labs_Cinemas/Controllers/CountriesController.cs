...
namespace Labs_Cinemas.Controllers
{
    ...
    public class CountriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,YearOfIndependency,CountOfFilms")] Countries countries)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,YearOfIndependency,CountOfFilms")] Countries countries)
        {
            if (id != countries.Id)
            {
                return NotFound();
